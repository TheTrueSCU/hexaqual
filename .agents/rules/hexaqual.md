...
1. **Architecture & Hexagonal Boundaries**:
   - `domain/`: Pure business logic, models, commands, and reports. Zero external framework dependencies.
   - `ports/`: Abstract ABC interfaces (`@abstractmethod`) specifying tool execution and presentation contracts.
