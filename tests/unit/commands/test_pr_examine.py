...
from hexaqual.commands.pr_examine import examine_pr, main
from hexaqual.domain.github import ExaminePrReport, OutputFormat, PrSummary
...
def test_examine_pr_dispatches_and_presents() -> None:
    ...
    with (
        patch(
            "hexaqual.commands.pr_examine.create_governance_bus",
            return_value=mock_bus,
        ),
        patch(
            "hexaqual.commands.pr_examine.create_github_presenter",
