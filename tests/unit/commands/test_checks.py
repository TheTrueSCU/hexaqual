...
from hexaqual.adapters.presenters.checks import build_checks_table
from hexaqual.commands.checks import app, checks, main
from hexaqual.domain.github import CheckRunFinding, ChecksReport, OutputFormat
...
def test_checks_command_execution() -> None:
    ...
    with (
        patch(
            "hexaqual.commands.checks.create_governance_bus",
            return_value=mock_bus,
        ),
        patch(
            "hexaqual.commands.checks.create_github_presenter",
