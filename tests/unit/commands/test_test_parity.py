...
from hexaqual.commands.test_parity import main
...
def test_test_parity_main_with_presenter(tmp_path) -> None:
    ...
    with (
        ...
        patch(
            "hexaqual.commands.test_parity.get_repo_root",
            return_value=tmp_path,
        ),
        patch(
            "hexaqual.commands.test_parity.check_test_directories_inits",
            return_value=[],
        ),
        patch(
            "hexaqual.commands.test_parity.check_src_to_test_symmetry",
            return_value=[],
        ),
    ):
