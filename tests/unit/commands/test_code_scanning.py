...
from hexaqual.domain.github import SecurityAlert
...
def test_inspect_single_alert_dispatches() -> None:
    ...
    from hexaqual.commands.code_scanning import inspect_single_alert
    from hexaqual.domain.github import CodeScanningReport
    ...
    with (
        patch(
            "hexaqual.commands.code_scanning.create_governance_bus",
            return_value=mock_bus,
        ),
        patch(
            "hexaqual.commands.code_scanning.create_github_presenter",
...
def test_inspect_and_bucket_alerts_dispatches() -> None:
    ...
    from hexaqual.commands.code_scanning import inspect_and_bucket_alerts
    from hexaqual.domain.github import CodeScanningReport
