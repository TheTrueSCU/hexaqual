...
@patch("hexaqual.commands.rope.handle_rename")
...
def test_alphabetize_main_dispatches_bus(tmp_path: Path) -> None:
    ...
    from hexaqual.domain.refactoring import AlphabetizeCodeReport
    ...
    with (
        patch("hexaqual.commands.rope.ensure_tool_installed"),
        patch(
