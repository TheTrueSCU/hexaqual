...
from hexaqual.commands.deptry import main, run_deptry_on_package
from hexaqual.domain.dependencies import DeptryAuditReport, RunDeptryAuditCommand
...
def test_deptry_main_dispatches_and_presents() -> None:
    ...
    with (
        patch("hexaqual.commands.deptry.ensure_tool_installed"),
        patch(
            "hexaqual.commands.deptry.create_governance_bus",
            return_value=mock_bus,
        ),
        patch(
            "hexaqual.commands.deptry.create_dependency_presenter",
