...
@patch("hexaqual.commands.mutmut.get_db_connection")
@patch("hexaqual.commands.mutmut.show_file_mutants")
...
def test_show_file_mutants_execution() -> None:
    ...
    with patch(
        "hexaqual.commands.coverage.get_tests_covering_line",
...
@patch("hexaqual.commands.mutmut._revert_bak_and_disk_mutations")
...
@patch("hexaqual.commands.mutmut.create_testing_presenter")
@patch("sys.exit")
