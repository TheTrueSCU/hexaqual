...
from hexaqual.commands.fuzz import (
...
def test_main_cli_success():
    ...
    with (
        ...
        patch("hexaqual.infra.handlers.analysis.run_target_fuzz") as mock_run,
        patch("hexaqual.commands.fuzz.display_fuzz_results") as mock_display,
    ):
